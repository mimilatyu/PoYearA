...
import com.example.poyeara.databinding.ListItemBinding
...
class WeatherAdapter(val listener: Listener?) : ListAdapter<WeatherModel, WeatherAdapter.Holder>(Comparator()) {
    ...
    //find a difference between old and new data
    ...
    //создаем каждый элемент списка, запускается столько раз, сколько элементов в списке
